            ...
            <div class="flex gap-x-4 my-3">
                <div class="w-[25rem] space-y-3">
                    ...
                    <div class="flex gap-x-1 items-center">
                        ...
                        <span class="text-xs text-muted">If old email already verified, you will need to check your old
                            email for
                            verification</span>
                    </div>
                </div>
                <div class="mt-auto mx-auto">
                    <UButton label="Save" type="submit" variant="soft" class="px-10" @click="updateUserInfo()"
                        size="xl" />
                </div>
            </div>
        </UForm>
...
import { changeEmail, updateUser, getSession, changePassword } from '~/lib/auth-client'
